...
export const siteConfig: SiteConfig = {
	title: "JS 블로그",
	subtitle: "야구 · 영화 · 요리 — 직접 보고 쓰는 정보",
	lang: "ko", // Language code, e.g. 'en', 'zh_CN', 'ja', etc.
	themeColor: {
		hue: 25, // 따뜻한 테라코타/오렌지 계열 (세련된 웜톤)
...
export const profileConfig: ProfileConfig = {
	...
	name: "JS 블로그",
	bio: "AI 초안에 사람의 관점을 더한 정보 블로그. 야구·영화·요리.",
	links: [],
};
...
export const seoConfig = {
	...
	naverSiteVerification: "903156e33dafcc26967e5144b4757549663fa8b2",    // 네이버 서치어드바이저 'HTML 태그' content 값
};
